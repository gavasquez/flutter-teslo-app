...
import 'package:teslo_shop/features/auth/providers/login_form_providers.dart';
...
class _LoginForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final loginForm = ref.watch(loginFromProvider);

    //* listen para estar escuchando un provicer
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            onChanged: (value) =>
                ref.read(loginFromProvider.notifier).onEmailChange(value),
